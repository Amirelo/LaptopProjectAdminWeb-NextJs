      ...
      <div className="mr-3">
        ...
        {showEditImageTab ? (
          <EditImageTab
            ...
            onDeletePress={onFinishedHandlingImages}
          />
        ) : (
          <></>
        )}
        ...
        <div className="flex flex-row items-center justify-between pt-4">
          <button
            ...
            className="bg-primaryColor px-6 py-3 rounded-md text-white hover:font-bold"
          >
            Add
          </button>
        ...
        <table className="w-full mt-10">
          <tr className="">
            ...
            <th className="border w-1/12" colSpan={2}>
              Action
            </th>
          </tr>
              ...
              return (
                ...
                >
                  ...
                  {product.productImageLink ? (
                    <td className="text-center border w-2/12">
                      <button onClick={() => onImagePressed(product)}>
                        <Image
                          className="w-fit h-fit m-auto rounded-md p-1"
                          objectFit="cover"
                          width={100}
                          height={100}
                    ...
                    <td className="text-center border block w-2/12">
                      <button
                        onClick={()=>onImagePressed(product)}
                        className="border hover:text-acceptColor hover:font-bold"
                      >
                        <svg
                  ...
                  <td className="text-center border">
                    {priceFormat(product.currentPrice)}
                  </td>
                  <td className="text-center border">
                  ...
                  <td className="text-center border">
                    <button
                      onClick={() => onEditIconPressed(product)}
                  ...
                  {product.status ? (
                    <td className="text-center border">
                      <button
                        onClick={() => onDeleteIconPressed(product)}
                    ...
                    <td className="text-center border">
                      <button
                        onClick={() => onRevertPressed(product)}
