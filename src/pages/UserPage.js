                            ...
                            return (
                                <tr className={user.accountStatus == 0 ? "bg-slate-500/25" : "even:bg-sky-50"} key={user.userId}>
                                    ...
                                    <td className="text-center border">
                                        <button onClick={() => onChangePasswordPressed(user)} className="hover:text-reviewColor transition-colors">
                                    ...
                                    {user.accountStatus != 0 ?
                                        <td className="text-center border">
                                            <button onClick={() => onDeleteIconPressed(user)} className="hover:text-cancelColor transition-colors">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        :
                                        <td className="text-center border">
                                            <button onClick={() => onRevertPressed(user)} className="hover:text-acceptColor transition-colors">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
