  ...
  return (
    <div className='h-full '>
      ...
      <nav className='flex flex-col w-72 h-full bg-inputBackgroundColor border-inputBorderColor border items-center fixed'>
        ...
        <a href='#' className='bg-mainSubColor text-black p-4 w-56 mt-7 rounded-md flex flex-row hover:bg-mainSubColor transition-colors duration-300'>
        ...
        <a href='#' className='text-black p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor transition-colors duration-300'>
