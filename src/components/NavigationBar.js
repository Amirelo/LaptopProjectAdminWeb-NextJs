  ...
  return (
    <>
      ...
      <nav className='flex flex-col w-72 h-full bg-inputBackgroundColor border-inputBorderColor border items-center fixed'>
        ...
        <NavLink to={"/"} className=' p-4 w-56 mt-7 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
        ...
        <Link to={"/products"} href='#' className=' p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
        ...
        <button onClick={onShowSpecsListPressed} className=' p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <NavLink to={"/orders"} className=' p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
        ...
        <Link to={"/users"} href='#' className=' p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <Link to={"reports"} href='#' className=' p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <Link to={"/settings"} href='#' className=' p-4 w-56 mt-1 rounded-md flex flex-row hover:bg-mainSubColor focus:bg-mainSubColor transition-colors duration-300'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
