    ...
    <>
      ...
      <nav className='flex flex-col w-72 h-full bg-backgroundInputColor border-borderColor border items-center fixed overflow-y-auto'>
        <div className='flex flex-row items-center mt-7'>
          ...
          <span className="text-primaryColor font-bold">Manager</span>
        </div>
        ...
        <button onClick={() => onShowSpecsListPressed(!showSpecsList)} className={`p-4 w-56 mt-1 rounded-md flex flex-row transition-all duration-300 ${selection == 'specs' ? "bg-primaryColor text-textVariantColor font-bold" : "hover:bg-primaryColor"}`}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <NavLink to={"/"} onClick={() => userLogout()} className={`p-4 w-56 mt-1 rounded-md flex flex-row transition-colors duration-300 text-errColor hover:bg-errColor hover:text-white mb-12`}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
