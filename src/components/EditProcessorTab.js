        ...
        <div className=" w-full h-full top-0 left-0 absolute">
            ...
            <div className="absolute w-1/2 left-1/3 top-8 h-fit rounded-2xl bg-inputBackgroundColor border border-inputBorderColor">
                ...
                <div className="flex flex-row items-center justify-center mx-4 mt-6">
                    <p className="w-1/4 mr-2">Processor Name</p>
                ...
                <div className="flex flex-row items-center justify-center mx-4 mt-2">
                    <p className="w-1/4 mr-2">CPU Speed</p>
                ...
                <div className="flex flex-row items-center justify-center mx-4 mt-2">
                    <p className="w-1/4 mr-2">Cores</p>
                ...
                <div className="flex flex-row items-center justify-center mx-4 mt-2">
                    <p className="w-1/4 mr-2">Logical Processors</p>
                ...
                <div className="flex flex-row items-center justify-center mx-4 mt-2">
                    <p className="w-1/4 mr-2">Cache Memory</p>
